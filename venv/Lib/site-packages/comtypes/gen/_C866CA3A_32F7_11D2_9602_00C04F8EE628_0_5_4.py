...
__all__ = [
    'SPSEMANTICFORMAT', 'DISPID_SpeechRecoContext', 'SVP_2',
    'DISPID_SVSyncronousSpeakTimeout', 'DISPID_SPAPhraseInfo',
    'SPEI_ACTIVE_CATEGORY_CHANGED', 'DISPID_SPPEngineConfidence',
    'DISPID_SPRuleChildren', 'eLEXTYPE_PRIVATE6', 'SVF_Emphasis',
    'DISPID_SRRTimes', 'SPWP_UNKNOWN_WORD_PRONOUNCEABLE',
    'SAFT48kHz16BitStereo', 'DISPID_SpeechPhoneConverter',
    'SPCS_DISABLED', 'DISPID_SDKSetBinaryValue', 'SVP_21',
    'SpeechLexiconType', 'SRARoot', 'SPEI_START_SR_STREAM',
    'DISPID_SDKDeleteValue', 'SVP_16', 'DISPID_SpeechLexiconProns',
    'SPWF_SRENGINE', 'SpInProcRecoContext', 'SPINTERFERENCE',
    'DISPID_SVGetAudioOutputs', 'DISPID_SPRuleEngineConfidence',
    'DISPID_SpeechGrammarRuleState', 'DISPID_SOTs_NewEnum',
    'DISPID_SCSBaseStream', 'SPPHRASEREPLACEMENT', 'DISPID_SRCState',
    'SPEI_END_SR_STREAM', 'SVEPhoneme', 'SPBO_PAUSE',
    'DISPID_SLWPronunciations', 'SPRS_INACTIVE',
    'DISPID_SOTDisplayUI', 'DISPID_SVSpeakStream',
    'DISPID_SVWaitUntilDone', 'DISPID_SpeechVoiceStatus',
    'SPINTERFERENCE_LATENCY_TRUNCATE_BEGIN', 'SPEI_MIN_TTS',
    'SAFT22kHz16BitStereo', 'SpeechRunState', 'SVP_3',
    'DISPID_SOTGetStorageFileName', 'SpeechPropertyResourceUsage',
    'DISPID_SRCEAdaptation', 'DISPID_SABIEventBias', 'SP_VISEME_10',
    'SREAudioLevel', 'SAFTGSM610_22kHzMono', 'SPRST_ACTIVE_ALWAYS',
    'SVP_11', '_SPAUDIOSTATE', 'DISPID_SGRSTransitions',
    'SpeechVoiceCategoryTTSRate', 'SPRULE', 'SPLO_STATIC',
    'DISPID_SpeechMMSysAudio', 'DISPID_SRRSetTextFeedback',
    'ISpeechDataKey', 'SPPS_Modifier', 'SAFTCCITT_ALaw_8kHzStereo',
    'UINT_PTR', 'DISPID_SGRSAddRuleTransition', 'DISPID_SOTDataKey',
    'DISPID_SRCEFalseRecognition', 'SECFEmulateResult',
    'ISpeechRecognizerStatus', 'eLEXTYPE_PRIVATE2',
    'SAFT22kHz16BitMono', 'DISPID_SPEDisplayAttributes', 'SSFMCreate',
    'DISPID_SRGCmdLoadFromProprietaryGrammar', 'DISPID_SGRsItem',
    'SVEWordBoundary', 'DISPID_SRCRecognizer', 'DISPID_SGRSTWeight',
    'DISPID_SGRSAddWordTransition', 'SpVoice', 'SpeechPartOfSpeech',
    'eLEXTYPE_PRIVATE3', 'DISPID_SABIBufferSize',
    'DISPID_SWFEAvgBytesPerSec', 'SAFTCCITT_ALaw_44kHzStereo',
    'SpeechDisplayAttributes', 'SPCS_ENABLED', 'SpPhoneConverter',
    'SPEI_MAX_TTS', 'SpeechGrammarRuleStateTransitionType',
    'SPEI_INTERFERENCE', 'DISPID_SRRGetXMLErrorInfo', 'SP_VISEME_9',
    'SREFalseRecognition', 'SREPrivate', 'SPRST_INACTIVE',
    'DISPID_SRCESoundStart', 'SAFT24kHz16BitStereo', 'SP_VISEME_7',
    'SPWT_DISPLAY', 'SpeechRegistryUserRoot',
    'DISPID_SPIAudioSizeBytes', 'SITooQuiet', 'DISPID_SPRulesItem',
    'DISPID_SpeechAudioStatus', 'DISPID_SPAsCount',
    'DISPID_SLGetWords', 'SRCS_Disabled', 'SRESoundStart',
    'DISPID_SpeechRecoResult', 'SpeechTokenContext',
    'ISpeechTextSelectionInformation', 'SFTInput', 'SGLexical',
    'DISPID_SVDisplayUI', 'DISPID_SRRecognizer', 'SpeechVisemeType',
    'SRTEmulated', 'SSTTWildcard', 'eLEXTYPE_PRIVATE16',
    'SVEBookmark', 'ISpeechWaveFormatEx', 'ISpeechLexicon',
    'SAFTGSM610_11kHzMono', 'DISPID_SRGetFormat',
    'DISPID_SpeechCustomStream', 'SpSharedRecoContext',
    'DISPID_SPAStartElementInResult', 'SpeechRecoEvents',
    'ISpObjectTokenCategory', 'SDTAll',
    'SPSMF_SRGS_SEMANTICINTERPRETATION_W3C', 'DISPID_SPRsItem',
    'DISPID_SPIEngineId', 'DISPID_SRRTLength',
    'SpeechEngineConfidence', 'ISpGrammarBuilder',
    'SpeechRecognizerState', 'SAFT24kHz16BitMono', 'DISPIDSPRG',
    'DISPID_SOTsCount', 'DISPID_SVEAudioLevel',
    'DISPID_SGRSTPropertyValue', 'DISPID_SRRAudio', 'STSF_AppData',
    'SpeechCategoryAudioOut', 'SP_VISEME_13', 'SRSInactive', 'SVP_13',
    'DISPID_SPRules_NewEnum', 'SGRSTTEpsilon',
    'Speech_Default_Weight', 'SpeechSpecialTransitionType',
    'ISpeechResourceLoader', 'SDA_No_Trailing_Space',
    'SPEI_PROPERTY_NUM_CHANGE', 'SPWORD', 'SAFTADPCM_22kHzMono',
    'DISPID_SVEVoiceChange', 'DISPID_SRProfile',
    'SAFT44kHz16BitStereo', 'SAFTADPCM_11kHzStereo', 'ISpEventSource',
    'DISPID_SPRuleFirstElement', 'DISPID_SPANumberOfElementsInResult',
    'SAFTCCITT_ALaw_8kHzMono', 'DISPID_SLWWord',
    'SpeechRegistryLocalMachineRoot', 'SPINTERFERENCE_TOOFAST',
    'SpeechVoiceEvents', 'DISPID_SpeechLexiconPronunciation',
    'DISPID_SPERetainedSizeBytes', 'DISPID_SGRName',
    'SPEI_START_INPUT_STREAM', 'SAFT44kHz8BitMono', 'SASPause',
    'DISPID_SVGetProfiles', 'DISPID_SOTRemoveStorageFileName',
    'SAFT32kHz8BitStereo', 'DISPID_SRCCreateResultFromMemory',
    'eLEXTYPE_PRIVATE5', 'DISPID_SDKGetBinaryValue',
    'DISPID_SLPPhoneIds', 'SPSHT_NotOverriden',
    ...
    'DISPID_SWFEChannels', 'ISpeechAudio', 'SPPS_SuppressWord',
    'DISPID_SGRAddState', 'SFTSREngine', 'DISPID_SRSAudioStatus',
    'SpFileStream', 'DISPID_SPCPhoneToId',
    'DISPID_SRSCurrentStreamNumber', 'DISPID_SpeechVoice',
    'SPVOICESTATUS', 'DISPID_SAVolume', 'SITooSlow',
    'STCRemoteServer', 'DISPID_SABufferNotifySize',
    'ISpeechPhoneConverter', 'SP_VISEME_16', 'ISpeechPhraseElements',
    'DISPID_SVGetVoices', 'SPEI_REQUEST_UI', 'IStream',
    'DISPID_SLPLangId', 'SpeechTokenKeyUI', 'SpeechRuleAttributes',
    'ISpeechGrammarRules', 'DISPID_SMSAMMHandle',
    'DISPID_SpeechRecoContextEvents', 'SRTReSent',
    'eLEXTYPE_PRIVATE4', 'SSTTTextBuffer', 'SRSEDone', 'SVEPrivate',
    'STCAll', 'SpeechStreamFileMode', 'SRCS_Enabled', 'SPAS_RUN',
    'SVP_7', 'SpCustomStream', 'DISPID_SBSSeek',
    'DISPID_SPCIdToPhone', 'SpeechBookmarkOptions',
    'SPEI_END_INPUT_STREAM', 'SDKLCurrentConfig',
    'DISPID_SpeechPhraseReplacement', 'DISPID_SPPConfidence',
    'SSSPTRelativeToCurrentPosition', 'DISPID_SGRsFindRule',
    'ISpeechPhraseAlternate', 'DISPID_SpeechAudioFormat',
    'DISPID_SVVolume', 'SPPHRASE', 'DISPID_SVRate', 'SDTAlternates',
    'DISPID_SpeechPhraseRules', 'DISPID_SVEventInterests',
    'ISpPhoneticAlphabetSelection', 'SAFTGSM610_44kHzMono',
    'DISPID_SMSADeviceId', 'DISPID_SGRSTNextState', 'SPEI_RESERVED1',
    'DISPID_SOTRemove', 'SPRS_ACTIVE_USER_DELIMITED',
    ...
    'SPGS_ENABLED', 'DISPID_SLWsCount', 'DISPID_SVAudioOutput',
    'eLEXTYPE_RESERVED8', 'SP_VISEME_20', 'ISpNotifySink',
    'SPXRO_SML', 'DISPID_SRCRetainedAudio', 'SAFT48kHz8BitMono',
    'DISPID_SPPNumberOfElements', 'DISPID_SOTCEnumerateTokens',
    'SpNullPhoneConverter', 'ISpeechAudioFormat', 'SPRST_ACTIVE',
    'SAFTCCITT_ALaw_22kHzStereo', 'DISPID_SVSPhonemeId',
    'SPDKL_LocalMachine', 'SPSHORTCUTPAIR', 'SAFTCCITT_uLaw_8kHzMono',
    'SITooLoud', 'SAFTADPCM_8kHzMono', 'SAFTDefault',
    'SAFTCCITT_uLaw_22kHzStereo', 'DISPID_SASFreeBufferSpace',
    'DISPID_SRGReset', 'SRATopLevel', 'SGLexicalNoSpecialChars',
    'STSF_CommonAppData', 'DISPID_SRRPhraseInfo', 'SPAR_Medium',
    'eLEXTYPE_PRIVATE18', 'DISPID_SPIReplacements',
    'SPINTERFERENCE_TOOSLOW', 'SPRULESTATE',
    'DISPID_SPRuleConfidence', 'DISPID_SPRuleParent',
    'ISpRecognizer2', 'DISPID_SPACommit', 'ISpLexicon',
    'SPEI_UNDEFINED', 'DISPID_SWFEBitsPerSample',
    'SpeechGrammarWordType', 'SVEEndInputStream', 'SRADynamic',
    'ISpeechGrammarRuleState', 'DISPID_SGRSTsCount', 'SVF_Stressed',
    'Speech_StreamPos_RealTime', 'SP_VISEME_5', 'SPSVerb',
    'SVEStartInputStream', 'ISpeechPhraseReplacements',
    'DISPID_SRCEPropertyNumberChange', 'SAFT32kHz16BitStereo',
    'DISPID_SRSClsidEngine', 'DISPID_SPRDisplayAttributes',
    'SPADAPTATIONRELEVANCE', 'ISpRecoContext', 'DISPID_SRState',
    'SPFM_NUM_MODES', 'SAFTCCITT_uLaw_11kHzStereo', 'SPCONTEXTSTATE',
    ...
    'DISPID_SVSCurrentStreamNumber', 'DISPID_SFSClose',
    'SPSEMANTICERRORINFO', 'SPEI_TTS_AUDIO_LEVEL', 'SP_VISEME_19',
    'SPSUnknown', 'SWTAdded', 'SPSModifier', 'SDKLLocalMachine',
    'SPGRAMMARSTATE', 'DISPID_SLWType',
    'SpeechDictationTopicSpelling', 'SVSFPersistXML', 'tagSTATSTG',
    'DISPID_SRGDictationSetState',
    'ISpeechGrammarRuleStateTransitions', 'SGRSTTTextBuffer',
    'SPSHT_Unknown', 'SGPronounciation', 'LONG_PTR',
    'DISPID_SpeechPhraseElements', 'SPVPRI_ALERT', 'SPCT_COMMAND',
    'SRESoundEnd', 'DISPID_SPIAudioSizeTime', 'SP_VISEME_4',
    'SpWaveFormatEx', 'DISPID_SOTsItem',
    'DISPID_SPEAudioStreamOffset', 'ISpeechXMLRecoResult',
    'SAFTCCITT_ALaw_11kHzMono', 'SPPS_Unknown', 'SPRECOGNIZERSTATUS',
    'SPCT_SLEEP', 'SGSDisabled', 'SAFT22kHz8BitMono',
    'DISPID_SVEStreamEnd', 'DISPID_SMSALineId', 'SVESentenceBoundary',
    'SP_VISEME_0', 'SpResourceManager', 'DISPID_SRGetPropertyNumber',
    'SPINTERFERENCE_LATENCY_TRUNCATE_END', 'SPPHRASEPROPERTY',
    'ISpeechRecoResult', 'SP_VISEME_3', 'SPEI_PHRASE_START',
    'SpeechWordPronounceable', 'eLEXTYPE_MORPHOLOGY', 'SPAS_PAUSE',
    'SPSTREAMFORMATTYPE', 'SP_VISEME_8', 'DISPID_SRCEEnginePrivate',
    'eWORDTYPE_DELETED', 'eLEXTYPE_RESERVED10', 'eLEXTYPE_PRIVATE1',
    'DISPID_SLWLangId', 'SAFTNonStandardFormat', 'SECFIgnoreCase',
    'SRAInterpreter', 'SVP_1', 'SAFT11kHz8BitStereo',
    'DISPID_SOTCDefault', 'SVEAudioLevel',
    '_ISpeechRecoContextEvents', 'DISPID_SPIEnginePrivateData',
    'DISPID_SPERetainedStreamOffset', 'DISPID_SPRNumberOfElements',
    'DISPID_SWFEExtraData', 'SVSFParseSapi',
    'SpeechAudioFormatGUIDText', 'SPRS_ACTIVE', 'SWTDeleted',
    'SSFMOpenForRead', 'ISpeechPhraseElement', 'DISPID_SpeechDataKey',
    'DISPID_SLAddPronunciationByPhoneIds', 'Speech_StreamPos_Asap',
    'DISPID_SASCurrentDevicePosition', 'eLEXTYPE_PRIVATE17',
    'SGDSActiveUserDelimited', 'DISPID_SBSFormat', 'SpShortcut',
    'ISpVoice', 'DISPID_SABufferInfo', 'SP_VISEME_15',
    'DISPID_SVSLastBookmark', 'SpeechRecognitionType',
    'ISpObjectWithToken', 'SPEI_FALSE_RECOGNITION',
    'SREPropertyStringChange', 'SPLEXICONTYPE', 'SPSFunction',
    'DISPID_SOTIsUISupported', 'DISPID_SVSInputSentenceLength',
    'SAFT8kHz8BitMono', 'SpUnCompressedLexicon',
    'SSSPTRelativeToStart', 'DISPID_SAFType',
    'DISPID_SRCSetAdaptationData', 'SWPUnknownWordPronounceable',
    'DISPID_SVAudioOutputStream', 'SPWORDPRONUNCIATION',
    'SPPROPERTYINFO', 'SPLO_DYNAMIC', 'SAFTCCITT_ALaw_11kHzStereo',
    'SpeechGrammarTagDictation', 'SPBO_TIME_UNITS', 'DISPID_SFSOpen',
    'SVPNormal', 'DISPID_SDKEnumKeys', 'SVSFPurgeBeforeSpeak',
    'SP_VISEME_14', 'DISPID_SMSSetData', 'SpLexicon',
    'DISPID_SRCPause', 'ISpAudio', 'SpeechRuleState',
    'SAFT24kHz8BitStereo', 'SRTExtendableParse',
    'SAFTADPCM_8kHzStereo', 'DISPID_SRCEInterference',
    'DISPID_SPRText', 'DISPID_SRGDictationLoad', 'SVP_14',
    'DISPID_SRGetRecognizers', 'SAFT12kHz16BitMono', 'ISpRecognizer3',
    'ISpRecoCategory', 'ISpeechPhraseAlternates',
    'IInternetSecurityManager', 'ISpMMSysAudio',
    'DISPID_SRCEAudioLevel', 'DISPID_SRSNumberOfActiveRules',
    'SAFTADPCM_22kHzStereo', 'DISPID_SPIGetDisplayAttributes',
    'SPFM_CREATE', 'SVSFNLPMask', 'DISPID_SPIGrammarId',
    'DISPID_SOTCId', 'eLEXTYPE_PRIVATE20',
    'DISPID_SLGetGenerationChange', 'SPCT_DICTATION', 'SVP_19',
    'SPPHRASERULE', 'ISpNotifySource', 'SP_VISEME_11',
    'SGRSTTDictation', 'DISPID_SASNonBlockingIO', 'SVP_6',
    'DISPID_SRCEPhraseStart', 'SPINTERFERENCE_TOOQUIET',
    'DISPID_SPAs_NewEnum', 'SPRST_NUM_STATES', 'SPEVENTENUM',
    'SPWP_UNKNOWN_WORD_UNPRONOUNCEABLE', 'SVP_5', 'DISPID_SPEsItem',
    'STCLocalServer', 'SPDATAKEYLOCATION', 'SPSMF_UPS',
    'DISPID_SVGetAudioInputs', 'SpTextSelectionInformation',
    'DISPID_SVAlertBoundary', 'SpeechUserTraining', 'DISPID_SLWsItem',
    'SPSSuppressWord', 'DISPID_SLRemovePronunciation',
    'eLEXTYPE_PRIVATE8', 'DISPID_SGRSRule', 'SPEI_SENTENCE_BOUNDARY',
    'eLEXTYPE_RESERVED6', 'DISPID_SGRSTRule', 'SDTLexicalForm',
    'SPEVENTSOURCEINFO', 'SpNotifyTranslator', 'SPCT_SUB_DICTATION',
    'SPWORDPRONUNCIATIONLIST', 'SPEI_ADAPTATION',
    'ISpeechLexiconPronunciations', 'DISPID_SDKDeleteKey',
    'SP_VISEME_6', 'SPEI_RECO_STATE_CHANGE', 'SVSFVoiceMask',
    'SpeechAddRemoveWord', 'ISpStreamFormat',
    'DISPID_SpeechGrammarRuleStateTransitions', 'DISPID_SPPName',
    'DISPID_SPIProperties', 'SpMMAudioEnum', 'SPWORDTYPE',
    'SRSEIsSpeaking', 'SRADefaultToActive', 'SPEI_SOUND_END',
    'SpAudioFormat', 'eLEXTYPE_PRIVATE13',
    'DISPID_SPEAudioTimeOffset', 'SDTRule', 'DISPIDSPTSI',
    'SPAS_CLOSED', 'SPXMLRESULTOPTIONS',
    'DISPID_SGRSAddSpecialTransition', 'DISPID_SDKCreateKey',
    'SVP_12', 'SRERecognition', 'DISPID_SRCVoice',
    'DISPID_SGRAttributes', 'SPPS_Interjection', 'SVEVoiceChange',
    'SDTProperty', 'DISPID_SVEPhoneme', 'eLEXTYPE_VENDORLEXICON',
    'SpeechRecoProfileProperties', 'SVSFlagsAsync',
    'SPWP_KNOWN_WORD_PRONOUNCEABLE', 'SpeechGrammarTagWildcard',
    'SPEI_WORD_BOUNDARY', 'SWPKnownWordPronounceable',
    'SPFM_OPEN_READONLY', 'ISpRecoGrammar', 'DISPID_SRGRecoContext',
    'DISPID_SOTCGetDataKey', 'DISPID_SPEActualConfidence',
    'SRAORetainAudio', 'ISpRecoResult', 'DISPID_SLAddPronunciation',
    'SVSFParseAutodetect', 'WAVEFORMATEX', 'DISPID_SOTCSetId',
    'DISPID_SWFEBlockAlign', 'SPINTERFERENCE_NONE', 'SVP_9',
    'DISPID_SVEStreamStart', 'DISPID_SRCreateRecoContext',
    'SpeechLoadOption', 'DISPID_SPPFirstElement', 'SPWF_INPUT',
    'SPSERIALIZEDPHRASE', 'eLEXTYPE_RESERVED7',
    'DISPID_SpeechRecoResult2', 'SpeechTokenValueCLSID',
    'DISPID_SRGCmdLoadFromMemory', 'SAFT32kHz8BitMono', 'ISpDataKey',
    'SpeechEngineProperties', 'eLEXTYPE_RESERVED9',
    'DISPID_SGRsDynamic', 'SpeechPropertyLowConfidenceThreshold',
    'SPPS_Noncontent', 'ISpPhrase', 'SpObjectTokenCategory',
    'DISPID_SWFESamplesPerSec', 'SpeechAudioVolume',
    'SAFT16kHz16BitStereo', 'DISPID_SpeechGrammarRules',
    '_ISpeechVoiceEvents', 'SBOPause', 'SPPHRASEELEMENT',
    'SAFT48kHz16BitMono', 'DISPID_SpeechPhraseProperties',
    'DISPID_SRIsUISupported', 'SECLowConfidence', 'DISPID_SPPId',
    'SGSEnabled', 'SRAExport', 'DISPID_SPRulesCount',
    ...
    'ISpeechObjectTokenCategory', 'eLEXTYPE_PRIVATE19',
    'SPXRO_Alternates_SML', 'DISPID_SLWs_NewEnum',
    'ISpeechCustomStream', 'SPEI_RESERVED6', 'SPSERIALIZEDRESULT',
    'DISPID_SAStatus', 'eLEXTYPE_RESERVED4', 'DISPID_SGRsCommit',
    'STSF_FlagCreate', 'SpeechInterference', 'DISPID_SRAudioInput',
    'SpeechGrammarTagUnlimitedDictation', 'SAFT44kHz8BitStereo',
    'SRERequestUI', 'SPEI_RESERVED5', 'ISpeechAudioStatus',
    'DISPIDSPTSI_SelectionOffset', 'SVSFNLPSpeakPunc',
    'ISpObjectToken', 'SpeechTokenIdUserLexicon', 'SLTUser',
    'DISPID_SPILanguageId', 'SpeechCategoryRecoProfiles',
    'SPPS_NotOverriden', 'SVEViseme', 'DISPID_SBSRead',
    'SAFTADPCM_44kHzStereo', 'DISPID_SOTId',
    'DISPID_SOTMatchesAttributes', 'DISPID_SAFGuid',
    'SWPUnknownWordUnpronounceable', 'SDKLDefaultLocation',
    'ISpeechVoice', 'SpeechCategoryRecognizers', 'SVP_8',
    'DISPID_SPRuleName', 'DISPID_SpeechLexiconWords',
    'DISPID_SASCurrentSeekPosition', 'eLEXTYPE_PRIVATE7',
    'SAFT11kHz16BitMono', 'ISpeechRecoContext', 'SPGS_DISABLED',
    'DISPID_SOTCreateInstance', 'SAFT16kHz8BitStereo', 'SRTStandard',
    'SPCT_SUB_COMMAND', 'DISPID_SRCEEndStream', 'ISpPhoneConverter',
    'SAFTCCITT_uLaw_8kHzStereo', 'DISPID_SVEViseme',
    'DISPID_SRSSupportedLanguages', 'DISPID_SPPsCount',
    'DISPID_SGRSTs_NewEnum', 'SVP_20', 'SPINTERFERENCE_TOOLOUD',
    'SDTReplacement', 'SRSActive', 'SPWORDPRONOUNCEABLE',
    'DISPID_SDKEnumValues', 'DISPID_SpeechObjectTokenCategory',
    'DISPID_SRCEventInterests', 'DISPID_SPEEngineConfidence',
    'SRAImport', 'SPRECOSTATE', 'DISPID_SGRSTsItem',
    'DISPID_SRRDiscardResultInfo', 'DISPID_SPIStartTime',
    'ISpeechRecoResultDispatch', 'SpMemoryStream',
    'DISPID_SADefaultFormat', 'DISPID_SPAsItem', 'SPEI_SOUND_START',
    'eLEXTYPE_APP', 'SP_VISEME_12', 'DISPID_SRRAudioFormat',
    'SPVISEMES', 'SVP_15', 'SpeechMicTraining', 'DISPID_SPRsCount',
    'SGDisplay', 'DISPID_SVSRunningState',
    'DISPID_SPPBRestorePhraseFromMemory', 'DISPID_SPEs_NewEnum',
    'SREAllEvents', 'DISPID_SGRSTText', 'DISPID_SPRs_NewEnum',
    'DISPID_SRCEHypothesis', 'SPEI_PHONEME', 'SpeechAudioFormatType',
    'DISPID_SpeechPhraseReplacements', 'SDKLCurrentUser',
    'DISPID_SPPChildren', 'SAFT8kHz8BitStereo',
    'SAFTCCITT_uLaw_44kHzStereo', 'DISPID_SPEDisplayText',
    'SECFNoSpecialChars', 'SAFTGSM610_8kHzMono', 'SECFDefault',
    'SpeechTokenShellFolder', 'DISPID_SLPsCount',
    'SAFT8kHz16BitStereo', 'DISPID_SRCBookmark', 'SDTDisplayText',
    'SPVPRIORITY', 'ISpeechRecoResult2', 'SPSHT_EMAIL', 'SAFTText',
    'DISPID_SRCRetainedAudioFormat', 'DISPID_SpeechGrammarRule',
    'DISPID_SRRRecoContext', 'SAFTExtendedAudioFormat',
    'SAFTCCITT_uLaw_22kHzMono', 'SPEI_PROPERTY_STRING_CHANGE',
    'ISpeechLexiconWord', 'SPFM_CREATE_ALWAYS', 'SPAS_STOP',
    'SpeechPropertyResponseSpeed', 'DISPID_SRGId',
    'DISPID_SpeechAudio', 'ISpStreamFormatConverter',
    'DISPID_SVSInputWordPosition', 'SPINTERFERENCE_NOISE',
    'DISPID_SVSLastResult', 'Speech_Max_Pron_Length',
    'DISPID_SpeechLexicon', 'SVSFParseSsml', 'SGSExclusive',
    'SpeechPropertyAdaptationOn', 'DISPID_SAFSetWaveFormatEx',
    'ISpNotifyTranslator', 'SGRSTTRule', 'DISPID_SRRTOffsetFromStart',
    'SP_VISEME_18', 'SAFT24kHz8BitMono',
    'DISPID_SpeechRecognizerStatus', 'SPPS_RESERVED1',
    'DISPID_SLPPartOfSpeech', 'SPSInterjection',
    'IInternetSecurityMgrSite', 'DISPID_SPPs_NewEnum',
    'SPAUDIOSTATUS', 'SpeechAllElements', 'SPGS_EXCLUSIVE',
    'DISPID_SASetState', 'DISPID_SpeechPhraseProperty',
    'tagSPTEXTSELECTIONINFO', 'SRERecoOtherContext',
    'SAFTADPCM_11kHzMono', 'DISPID_SpeechLexiconWord', 'SPAR_High',
    'DISPID_SGRSTPropertyName', 'SPFILEMODE',
    'DISPID_SVSLastBookmarkId', 'ISpeechRecognizer',
    'SPEI_SR_BOOKMARK', 'SPRECORESULTTIMES', 'DISPID_SPISaveToMemory',
    'DISPID_SRGetPropertyString', 'DISPID_SRIsShared',
    'DISPID_SGRSTPropertyId', 'ISpeechRecoResultTimes',
    'DISPID_SVSInputWordLength', 'DISPID_SPIRule', 'SVP_0',
    'SDA_Consume_Leading_Spaces', 'DISPID_SRCCreateGrammar',
    'ISpeechGrammarRuleStateTransition', 'SPSHT_OTHER',
    'eLEXTYPE_USER_SHORTCUT', 'SPEI_TTS_PRIVATE',
    'SAFTADPCM_44kHzMono', 'SINoSignal',
    'SpeechVoiceSkipTypeSentence', 'SGDSInactive',
    'DISPID_SRCEBookmark', 'DISPID_SVSpeakCompleteEvent',
    'DISPID_SGRsCount', 'SpeechCategoryAppLexicons', 'DISPID_SVSpeak',
    'SPWT_LEXICAL', 'SPEI_VISEME', 'SpeechDiscardType',
    '__MIDL___MIDL_itf_sapi_0000_0020_0002', 'ISpRecognizer',
    'SpeechCategoryAudioIn',
    'DISPID_SRAllowVoiceFormatMatchingOnNextSet',
    'SPSMF_SAPI_PROPERTIES', 'SRTSMLTimeout',
    'DISPID_SpeechWaveFormatEx', 'SAFTCCITT_uLaw_11kHzMono',
    'SPPARTOFSPEECH', 'SpStream', 'SRSInactiveWithPurge',
    'ISpeechRecoGrammar', 'ISpeechFileStream', 'ISpSerializeState',
    'SVSFUnusedFlags', 'DISPID_SVResume', 'SECHighConfidence',
    'SVSFDefault', 'SPVPRI_OVER', 'ISpeechGrammarRule',
    'DISPID_SpeechObjectToken', 'SAFT32kHz16BitMono',
    'ISpRecoContext2', 'DISPID_SGRs_NewEnum',
    'SPSMF_SRGS_SAPIPROPERTIES', 'DISPID_SGRSTType', 'SPPS_RESERVED4',
    'SPEI_RESERVED2', 'SPDKL_CurrentUser', 'SpeechVoicePriority',
    'eLEXTYPE_USER', 'SAFT16kHz8BitMono', 'DISPID_SPIGetText',
    'DISPID_SVPriority', 'SECFIgnoreKanaType', 'SVSFParseMask',
    'SAFT11kHz16BitStereo', 'DISPID_SVPause', 'ISpRecoGrammar2',
    'SPCATEGORYTYPE', 'DISPID_SRCRequestedUIType', 'SITooFast',
    'IEnumString', 'SPEI_SR_PRIVATE', 'DISPID_SpeechFileStream',
    'SpeechWordType', 'SVP_18', 'DISPID_SVIsUISupported', 'SASClosed',
    'DISPID_SRGCmdLoadFromResource', 'SpeechFormatType',
    'SpeechVisemeFeature', 'ISpeechLexiconPronunciation',
    'SGRSTTWord', '_RemotableHandle', 'SAFTCCITT_ALaw_44kHzMono',
    'SREBookmark', '__MIDL_IWinTypes_0009', 'SPINTERFERENCE_NOSIGNAL',
    'SRSActiveAlways', 'DISPID_SLGenerationId', 'DISPID_SRGCommit',
    'DISPID_SGRInitialState', 'DISPID_SRRGetXMLResult',
    'eLEXTYPE_PRIVATE12', 'SPGRAMMARWORDTYPE', 'DISPID_SRDisplayUI',
    'DISPID_SAEventHandle', 'DISPID_SRRSpeakAudio',
    'SSSPTRelativeToEnd', 'DISPID_SBSWrite', 'SpeechTokenKeyFiles',
    'SLOStatic', 'SPSNoun', 'SLTApp', 'ISpeechObjectToken',
    'DISPID_SDKSetLongValue', 'SREHypothesis',
    'SPRS_ACTIVE_WITH_AUTO_PAUSE', 'SPWT_PRONUNCIATION',
    'DISPID_SRCCmdMaxAlternates', 'ISpProperties', 'DISPID_SGRClear',
    'SINoise', 'DISPID_SVEBookmark', 'DISPID_SRStatus',
    'DISPID_SpeechMemoryStream', 'DISPID_SRCVoicePurgeEvent',
    'SpeechEmulationCompareFlags', 'DISPID_SLPType',
    'tagSPPROPERTYINFO', 'SPAO_NONE', 'DISPID_SPPValue',
    'SAFT16kHz16BitMono', 'DISPID_SpeechXMLRecoResult',
    'DISPID_SABIMinNotification', 'SAFT12kHz8BitStereo',
    'DISPIDSPTSI_ActiveOffset', 'SAFTTrueSpeech_8kHz1BitMono',
    'DISPID_SDKGetlongValue', 'DISPID_SDKOpenKey',
    'DISPID_SRGSetWordSequenceData', 'SVP_4', 'SPSHORTCUTPAIRLIST',
    'DISPID_SVVoice', 'SREAdaptation', 'DISPID_SRRAlternates',
    'SASRun', 'DISPID_SRGCmdSetRuleState', 'ISpeechBaseStream',
    'DISPID_SVStatus', 'SREStreamEnd', 'SPPS_Function',
    'SPEI_TTS_BOOKMARK', 'SPSLMA', 'DISPID_SPCLangId', 'ISpPhraseAlt',
    'DISPID_SRGRules', 'SpeechRecoContextState', 'SPAUDIOOPTIONS',
    'SRTAutopause', 'ISpEventSink', 'ISpeechLexiconWords',
    'DISPID_SVEWord', 'SAFTCCITT_ALaw_22kHzMono', 'SAFT12kHz8BitMono',
    'ISpeechPhraseProperty', 'SVP_17', 'SSTTDictation',
    'SP_VISEME_21', 'DISPID_SDKGetStringValue', 'DISPID_SMSGetData',
    'SpMMAudioOut', 'SpeechDataKeyLocation', 'DISPID_SPARecoResult',
    'DISPID_SRRSaveToMemory', 'SVP_10', 'ISpeechMemoryStream',
    'SPWAVEFORMATTYPE', 'SPEI_SR_AUDIO_LEVEL',
    'DISPID_SPIAudioStreamPosition', 'DISPID_SRGDictationUnload',
    'SpeechStreamSeekPositionType', 'SDTPronunciation',
    'SAFT11kHz8BitMono', 'DISPID_SRCResume', 'DISPID_SVSkip',
    'SPLOADOPTIONS', 'SPEI_HYPOTHESIS', 'DISPID_SOTGetDescription',
    'ISpPhoneticAlphabetConverter', 'DISPID_SLPsItem',
    'SVSFIsFilename', 'SREPropertyNumChange', 'SAFT8kHz16BitMono',
    'eLEXTYPE_PRIVATE15', 'ISpeechAudioBufferInfo',
    'DISPID_SLGetPronunciations', 'DISPID_SPEAudioSizeTime',
    'SECFIgnoreWidth', 'SVF_None', 'DISPID_SRGCmdLoadFromObject',
    'DISPID_SRGCmdSetRuleIdState', 'Speech_Max_Word_Length',
    'SPVPRI_NORMAL', 'DISPID_SpeechRecognizer', 'SPBO_AHEAD',
    'SPFM_OPEN_READWRITE', 'SPPS_RESERVED2',
    'DISPID_SVESentenceBoundary', 'SAFT22kHz8BitStereo',
    'ISequentialStream', 'SSFMOpenReadWrite',
    'DISPID_SRCEStartStream', 'SPPS_Verb', 'DISPID_SPRuleId',
    'SVSFIsXML', 'DISPID_SRRTStreamTime', 'DISPID_SRGIsPronounceable',
    'SP_VISEME_1', 'ISpeechPhraseReplacement', 'SPAO_RETAIN_AUDIO',
    'DISPID_SGRsCommitAndSave', 'SAFTCCITT_uLaw_44kHzMono',
    'eLEXTYPE_PRIVATE11', 'SPDKL_DefaultLocation',
    'SSFMCreateForWrite', 'DISPID_SASState',
    'SpeechPropertyComplexResponseSpeed',
    'DISPID_SpeechGrammarRuleStateTransition',
    'DISPID_SpeechBaseStream', 'ISpResourceManager',
    'DISPID_SpeechVoiceEvent', 'SPEI_MIN_SR', 'SASStop',
    'SGRSTTWildcard', 'SPSMF_SRGS_SEMANTICINTERPRETATION_MS',
    'ISpeechPhraseProperties', 'SPAUDIOSTATE',
    'DISPID_SRGSetTextSelection', 'SPBOOKMARKOPTIONS',
    'SpSharedRecognizer', 'SPBINARYGRAMMAR',
    'DISPID_SRAllowAudioInputFormatChangesOnNextSet',
    'DISPID_SPIRetainedSizeBytes', 'SPWT_LEXICAL_NO_SPECIAL_CHARS',
    'SVEAllEvents', 'eLEXTYPE_PRIVATE10', 'SPEI_VOICE_CHANGE',
    'SpMMAudioIn', 'DISPID_SRGState',
    'DISPID_SRCEPropertyStringChange', 'DISPIDSPTSI_ActiveLength',
    'SGDSActive', 'SLODynamic', 'SpStreamFormatConverter',
    'SpeechAudioProperties', 'DISPID_SPIElements',
    'STSF_LocalAppData', 'DISPID_SGRsAdd',
    'DISPID_SRSetPropertyString', 'SAFTNoAssignedFormat',
    'DISPID_SOTGetAttribute', 'SPPS_Noun', 'ISpShortcut',
    'DISPID_SPPParent', 'SpPhraseInfoBuilder', 'ISpeechObjectTokens',
    'SPAUDIOBUFFERINFO', 'SP_VISEME_17', 'SPEI_RESERVED3',
    'DISPID_SREmulateRecognition', 'DISPID_SpeechPhraseElement',
    'ISpXMLRecoResult', 'SpeechPropertyHighConfidenceThreshold',
    'DISPID_SRCAudioInInterferenceStatus', 'ISpeechVoiceStatus',
    'DISPID_SPEsCount', 'eLEXTYPE_PRIVATE9',
    'DISPID_SRCERecognizerStateChange',
    'DISPID_SPERequiredConfidence', 'DISPID_SRCESoundEnd',
    'SREPhraseStart', 'IEnumSpObjectTokens',
    'ISpeechPhraseInfoBuilder', 'SPWORDLIST', 'SREStreamStart',
    'DISPID_SLPs_NewEnum', 'SPRST_INACTIVE_WITH_PURGE',
    'DISPID_SpeechAudioBufferInfo', 'SVSFIsNotXML', 'SREStateChange',
    'DISPID_SOTCategory', 'SDTAudio', 'SpPhoneticAlphabetConverter',
    'SAFT44kHz16BitMono', 'DISPID_SLPSymbolic',
    'DISPID_SPEPronunciation', 'SPBO_NONE', 'SPSHORTCUTTYPE',
    'SVPOver', 'DISPID_SWFEFormatTag',
    'SPINTERFERENCE_LATENCY_WARNING', 'SGDSActiveWithAutoPause',
    'eWORDTYPE_ADDED', 'DISPID_SRGCmdLoadFromFile',
    'SPEI_SR_RETAINEDAUDIO', 'DISPID_SGRAddResource', 'SPEI_MAX_SR',
    'SpeechVoiceSpeakFlags', 'SpeechGrammarState', 'SPAR_Low',
    'DISPID_SVAllowAudioOuputFormatChangesOnNextSet',
    'eLEXTYPE_PRIVATE14', 'DISPID_SVSLastStreamNumberQueued',
    'SECNormalConfidence', 'SPEVENT', 'SPAR_Unknown',
    'DISPID_SOTSetId', 'ISpeechPhraseRules', 'ISpeechPhraseInfo',
    'DISPID_SVEEnginePrivate', 'SpeechAudioState', 'SBONone',
    'SPPS_RESERVED3', 'DISPIDSPTSI_SelectionLength', 'SpObjectToken',
    'SDA_One_Trailing_Space', 'DISPID_SRCERecognition',
    'DISPID_SVSInputSentencePosition', 'SPPS_LMA', 'SVPAlert',
    'SPTEXTSELECTIONINFO', 'SPSNotOverriden',
    'DISPID_SPRuleNumberOfElements', 'SAFT12kHz16BitStereo',
    'SRAONone', 'DISPID_SPRFirstElement', 'SPEI_RECO_OTHER_CONTEXT',
    'DISPID_SLRemovePronunciationByPhoneIds', 'DISPID_SPPsItem',
    'SpCompressedLexicon', 'SPDKL_CurrentConfig', 'ISpeechPhraseRule',
    'STCInprocServer', 'ISpeechMMSysAudio', 'DISPID_SGRId',
    'SpeechRetainedAudioOptions', 'SPRECOCONTEXTSTATUS', 'ISpStream',
    'DISPID_SpeechPhraseRule', 'SAFT48kHz8BitStereo',
    'DISPID_SRSetPropertyNumber', 'SREInterference',
    'DISPID_SDKSetStringValue', 'SINone', 'DISPID_SRAudioInputStream'
]

_check_version('1.1.14', 1612894433.148030)
